...
<Callout type="info" title="Attribution">
This implementation is inspired by [Boris Tane's](https://boristane.com) excellent article ["Traditional Logging Sucks"](https://loggingsucks.com/) which articulates the philosophy of wide events and their benefits. The concept of "Canonical Log Lines" was originally popularized by Stripe.
</Callout>
