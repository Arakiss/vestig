export const metadata = {
  title: 'Sampling',
  description: 'Control log volume in Vestig with sampling. Probability sampling, rate limiting, and namespace-based strategies.',
}
...
- [Tracing](/docs/tracing) — Track operations with spans
