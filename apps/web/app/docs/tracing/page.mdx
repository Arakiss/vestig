export const metadata = {
  ...
  description: 'Native tracing support in Vestig for tracking operations and relationships. Spans, context propagation, and W3C Trace Context.',
}
...
- [Core Logging](/docs/core/logging) — Basic logging concepts
