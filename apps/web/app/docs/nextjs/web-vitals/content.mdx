...
- [Dev Overlay](/docs/nextjs/dev-overlay) — View metrics in real-time
- [Error Boundary](/docs/nextjs/error-boundary) — Handle errors gracefully
- [Logging Basics](/docs/core/logging) — Understand structured logging
