export const metadata = {
  ...
  description: 'First-class Next.js 15+ support with @vestig/next. Server Components, Route Handlers, Server Actions, middleware integration.',
}
