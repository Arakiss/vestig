export const metadata = {
  ...
  description: 'Query logging integration for Prisma and Drizzle ORMs.',
}

# Database Logging

Automatic query logging for Prisma and Drizzle ORMs with slow query detection, parameter sanitization, and correlation ID tracking.
...
Create a Vestig-compatible logger for Drizzle:
