...
- [Dev Overlay](/docs/nextjs/dev-overlay) — See breadcrumbs in real-time
- [Logging Basics](/docs/core/logging) — Log errors properly
- [Error Handling](/docs/advanced/error-handling) — Error serialization
