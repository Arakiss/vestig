...
- [Console Transport](/docs/transports/console) — Detailed console options
- [HTTP Transport](/docs/transports/http) — HTTP configuration and error handling
- [File Transport](/docs/transports/file) — File rotation and compression
- [Datadog Transport](/docs/transports/datadog) — Datadog integration details
- [Custom Transports](/docs/transports/custom) — Build your own transport
