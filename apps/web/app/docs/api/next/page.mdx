export const metadata = {
  title: '@vestig/next API Reference',
  description: 'Complete API documentation for the Next.js integration package. Server, client, and middleware exports.',
}
...
interface VestigProviderProps {
  ...
  endpoint?: string | false  // Defaults to '/api/vestig'; false disables remote delivery
  namespace?: string
